...
MouseGame.Preloader.prototype = {
    ...
    preload: function () {
        ...
        game.load.image('button-mute','assets/buttons/buttons_KO/mute_audio.png');
        game.load.image('button-unmute','assets/buttons/buttons_KO/unmute_audio.png');
        ...
        game.load.image('ending','assets/backgrounds/backgrounds_KO/ending.jpg');
        //
        ...
        game.load.image('logo','assets/buttons/buttons_KO/menu_title.png');
        //
        ...
        game.load.image('title','assets/backgrounds/backgrounds_KO/title.jpg');
        //
