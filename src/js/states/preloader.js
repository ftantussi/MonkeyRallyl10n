...
MouseGame.Preloader.prototype = {
    ...
    preload: function () {
        ...
        // Load everything!!
        game.load.script('intro-i10n', 'assets/content/' + language + '/introContent.js');
        game.load.script('credits-i10n', 'assets/content/' + language + '/creditsContent.js');
        game.load.script('game-i10n', 'assets/content/' + language + '/gameContent.js');
        game.load.script('level-i10n', 'assets/content/' + language + '/levelContent.js');
        game.load.script('meni-i10n', 'assets/content/' + language + '/mainmenuContent.js');
    ...
    loadLanguage: function () {
        ...
        console.log("Loading language: " + language.toUpperCase());
        "use strict";

        game.load.image('background', 'assets/backgrounds/background.jpg');
//        game.load.image('button', 'assets/buttons/button.png');
        ...
        game.load.image('button-mute', 'assets/buttons/buttons_' + language + '/mute_audio.png');
        game.load.image('button-unmute', 'assets/buttons/buttons_' + language + '/unmute_audio.png');
        ...
        game.load.image('ending', 'assets/backgrounds/backgrounds_' + language + '/ending.jpg');
        game.load.image('title', 'assets/backgrounds/backgrounds_' + language + '/title.jpg');
